      ...
      <div className="container mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-16 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-slate-900 rounded-full mb-3 sm:mb-6">
            ...
            <span className="text-white font-semibold text-[10px] sm:text-sm tracking-wide">GET IN TOUCH</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              {showSuccess && (
                <div className="mb-4 sm:mb-6 bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 sm:px-6 sm:py-4 rounded-xl flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    <strong className="font-semibold block mb-0.5 sm:mb-1 text-xs sm:text-base">Message sent successfully!</strong>
              ...
              {/* Form Card - Compact Padding */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-slate-200 p-5 sm:p-10">
            ...
            {/* Contact Information Sidebar - Compact & Horizontal on Mobile if needed, or Stacked nicely */}
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-6 mt-4 lg:mt-0">
              ...
              <div className="bg-white rounded-xl shadow-sm sm:shadow-md border border-slate-200 p-4 sm:p-6 hover:shadow-lg transition-shadow">
                ...
                <h4 className="text-slate-900 font-semibold text-xs sm:text-base mb-1 sm:mb-2">Email Us</h4>
                <p className="text-slate-600 text-[10px] sm:text-sm break-all">kyysolutions17@gmail.com</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm sm:shadow-md border border-slate-200 p-4 sm:p-6 hover:shadow-lg transition-shadow">
                ...
                <h4 className="text-slate-900 font-semibold text-xs sm:text-base mb-1 sm:mb-2">Call Us</h4>
                <p className="text-slate-600 text-[10px] sm:text-sm">+62 812-3291-6758</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm sm:shadow-md border border-slate-200 p-4 sm:p-6 hover:shadow-lg transition-shadow">
                ...
                <h4 className="text-slate-900 font-semibold text-xs sm:text-base mb-1 sm:mb-2">Visit Us</h4>
              ...
              <div className="bg-slate-900 rounded-xl shadow-sm sm:shadow-md p-4 sm:p-6 text-white">
                <h4 className="font-semibold text-xs sm:text-base mb-1 sm:mb-2">Business Hours</h4>
