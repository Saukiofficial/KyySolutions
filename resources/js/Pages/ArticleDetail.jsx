...
export default function ArticleDetail({ article, relatedArticles = [], settings }) {
    ...
    const getImageUrl = (path, fallbackText = 'Article') => {
        if (!path) {
            return `https://placehold.co/1200x700/e0f2fe/2563eb?text=${encodeURIComponent(fallbackText)}`;
        }
    ...
    const publishedRelatedArticles = relatedArticles.filter((item) => item?.is_published !== false);
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-gray-900">
            ...
            <div
                className="fixed top-0 left-0 h-1 bg-blue-600 z-[60] transition-all duration-100"
                    ...
                    <div className="flex items-center gap-4 overflow-hidden w-full md:w-auto">
                        ...
                        <span className="truncate font-medium">
                            {publishedRelatedArticles.length > 0
                                ? publishedRelatedArticles[0].title
                                : 'Temukan wawasan menarik lainnya di sini.'}
                        </span>
                    </div>
            ...
            <div className="bg-white border-b border-gray-200 sticky top-20 z-40 shadow-sm">
                <div className="container mx-auto px-4 py-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600 overflow-x-auto whitespace-nowrap">
                        ...
                        <span>›</span>
                        <Link href={route('news.index')} className="hover:text-blue-600 transition-colors">
                            Berita & Insight
                        </Link>
                        <span>›</span>
            ...
            <main className="container mx-auto px-4 py-8 pb-20">
                <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="hidden lg:flex lg:col-span-1 flex-col items-center gap-4 sticky top-40 h-fit">
                        <p className="text-xs font-bold text-gray-400 uppercase rotate-180 writing-vertical-lr mb-2">
                            Bagikan
                        </p>
                        ...
                        <button className="p-3 bg-white rounded-full text-gray-500 hover:text-red-500 hover:shadow-lg transition-all border border-gray-100" title="Email">
                            <Mail size={18} />
                        </button>
                    </div>
                    ...
                    <div className="lg:col-span-7">
                        <article className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100">
                            ...
                            <figure className="mb-10 rounded-xl overflow-hidden shadow-lg relative group">
                                <img
                                    src={getImageUrl(article.thumbnail, article.title || 'Article')}
                                    alt={article.title}
                            ...
                            <div className="mt-12 pt-8 border-t border-gray-100">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {[article.category || 'News', 'Technology', 'Business', 'Innovation', 'Digital'].map((tag) => (
                                        <span
                                            key={tag}
                                            className="px-4 py-1.5 bg-gray-50 text-gray-600 border border-gray-200 rounded-lg text-sm hover:border-blue-500 hover:text-blue-600 cursor-pointer transition-colors"
                                        >
                                            #{tag}
                                        </span>
                                    ))}
                        ...
                        <div className="mt-8 p-8 bg-gradient-to-r from-blue-900 to-indigo-900 rounded-2xl text-center text-white shadow-xl relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-blue-200 mb-6 max-w-md mx-auto text-sm">
                                    Dapatkan update artikel teknologi terbaru dan tips bisnis langsung ke email Anda.
                                </p>
                                <div className="flex max-w-sm mx-auto gap-2">
                                    <input
                                        type="email"
                                        placeholder="Email Anda..."
                                        className="flex-1 px-4 py-3 rounded-lg text-gray-900 border-none focus:ring-2 focus:ring-blue-300 text-sm"
                                    />
                    ...
                    <aside className="lg:col-span-4 space-y-8">
                                        ...
                                        >
                                            <div className="flex gap-4">
                                                <div className="w-24 h-20 flex-shrink-0 rounded-lg overflow-hidden relative shadow-sm">
                                                    <img
                                                        src={getImageUrl(related.thumbnail, related.title || 'Article')}
                                                        alt={related.title}
                        ...
                        <div className="rounded-xl overflow-hidden shadow-lg relative h-80 group cursor-pointer border border-gray-100">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/90 to-transparent flex items-end p-6">
                                <div>
                                    <p className="text-yellow-400 font-bold text-xs mb-1 uppercase tracking-widest">
                                        KYY SOLUTIONS
                                    </p>
                                    ...
                                    <Link
                                        href="/#contact"
                                        className="inline-block bg-white text-blue-900 px-4 py-2 rounded-lg font-bold text-xs hover:bg-blue-50 transition-colors shadow-lg"
                                    >
                                        Konsultasi Gratis
                                    </Link>
                                </div>
