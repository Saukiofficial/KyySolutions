            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Add a team member profile with role, photo, and social media links.
                    </p>
                </div>
            </div>
                ...
                <div class="relative overflow-hidden border-b border-gray-200 bg-gray-950 px-8 py-8 text-white">
                    ...
                    <div class="relative">
                        ...
                        <p class="mt-2 max-w-2xl text-sm leading-6 text-gray-300">
                            Fill in member details and optional social media links for your website team section.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="rounded-3xl border border-gray-200 bg-gray-950 p-6 text-white shadow-xl shadow-gray-900/10">
                                <h4 class="text-lg font-bold">Team Tip</h4>
                                <p class="mt-2 text-sm leading-6 text-gray-400">
                                    Gunakan foto yang konsisten agar tampilan team section terlihat lebih profesional dan premium.
                                </p>
                            </div>
                        </div>
                    </div>
