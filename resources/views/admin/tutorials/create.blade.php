<x-admin-layout>
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Tulis tutorial profesional dengan editor seperti WordPress.
                    </p>
                </div>
            </div>
                        ...
                        <div class="sticky top-6 space-y-6">
                            ...
                            <div class="rounded-[2rem] border border-gray-200 bg-gray-950 p-6 text-white shadow-xl shadow-gray-900/10">
                                ...
                                <p class="mt-2 text-sm leading-6 text-gray-400">
                                    Buat tutorial dengan struktur langkah-langkah, gunakan heading, gambar, dan tabel agar mudah dipahami pembaca.
                                </p>
                            </div>
    ...
    <script>
        ...
        const storageKey = `${window.location.pathname}:cms-editor-draft:tutorial`;
        ...
        ClassicEditor
            ...
            .then(editor => {
                ...
                const initialData = editor.getData().trim();
