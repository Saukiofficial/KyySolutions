            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Manage your portfolio projects and filter them by category.
                    </p>
                </div>
            </div>
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Portfolio data has been updated successfully.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form method="GET" action="{{ route('admin.portfolios.index') }}">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Select a category to filter displayed portfolio projects.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                            <select name="category"
                                    ...
                                    class="block w-full rounded-2xl border border-gray-200 bg-gray-50 px-5 py-4 text-sm font-semibold text-gray-700 outline-none transition focus:border-gray-950 focus:bg-white focus:ring-4 focus:ring-gray-900/5 sm:w-72">
                ...
                <div class="border-b border-gray-200 bg-gray-50 px-6 py-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                View, edit, and delete portfolio projects.
                            </p>
                        </div>
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            @forelse ($portfolios as $portfolio)
                                <tr class="transition hover:bg-gray-50">
                                    <td class="px-6 py-5">
                                        <div class="h-14 w-20 overflow-hidden rounded-2xl border border-gray-200 bg-gray-100 shadow-sm">
                                            @if($portfolio->image)
