            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Create a new project showcase with thumbnail, technologies, features, and gallery.
                    </p>
                </div>
            </div>
                ...
                <div class="relative overflow-hidden border-b border-gray-200 bg-gray-950 px-8 py-8 text-white">
                    ...
                    <div class="relative">
                        ...
                        <p class="mt-2 max-w-2xl text-sm leading-6 text-gray-300">
                            Fill in the project details and upload supporting images for your portfolio showcase.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="description"
                                              ...
                                              class="block w-full resize-none rounded-2xl border border-gray-200 bg-white px-5 py-4 text-sm font-medium leading-7 text-gray-950 outline-none transition placeholder:text-gray-400 focus:border-gray-950 focus:ring-4 focus:ring-gray-900/5">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm font-medium text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-xs leading-5 text-gray-500">
                                        Gambar utama yang muncul di halaman depan.
                                    </p>
                                    @error('image')
                                        <p class="mt-2 text-sm font-medium text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="features"
                                                  ...
                                                  class="block w-full resize-none rounded-2xl border border-gray-200 bg-white px-5 py-4 text-sm font-medium leading-7 text-gray-950 outline-none transition placeholder:text-gray-400 focus:border-gray-950 focus:ring-4 focus:ring-gray-900/5">{{ old('features') }}</textarea>
                                        <p class="mt-2 text-xs leading-5 text-gray-500">
                                    ...
                                    <div class="rounded-3xl border border-dashed border-gray-300 bg-white p-5">
                                        <div class="mb-4 flex items-start justify-between gap-4">
                                            <div>
                                                ...
                                                <p class="mt-1 text-xs leading-5 text-gray-500">
                                                    Upload multiple images for project showcase.
                                                </p>
                                            </div>
                                        ...
                                        <p class="mt-3 text-xs leading-5 text-gray-500">
                                            Anda bisa memilih banyak gambar sekaligus dengan Ctrl + Click.
                                        </p>
                            ...
                            <div class="rounded-3xl border border-gray-200 bg-gray-950 p-6 text-white shadow-xl shadow-gray-900/10">
                                <h4 class="text-lg font-bold">Portfolio Tip</h4>
                                <p class="mt-2 text-sm leading-6 text-gray-400">
                                    Pakai thumbnail yang rapi dan deskripsi singkat agar project terlihat lebih profesional di halaman depan.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-4 border-t border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-start gap-3 text-sm text-gray-500">
                            ...
                            <div>
                                ...
                                <p class="mt-0.5">Portfolio will be saved after submit.</p>
                            </div>
                        </div>
