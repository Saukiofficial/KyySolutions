...
>
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
        ...
        <a href="{{ route('admin.partners.index') }}" class="flex items-center px-4 py-2 text-gray-700 rounded-md dark:text-gray-200 {{ request()->routeIs('admin.partners.*') ? 'bg-indigo-200 dark:bg-indigo-600' : 'hover:bg-indigo-200 dark:hover:bg-indigo-600' }}">
            <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
